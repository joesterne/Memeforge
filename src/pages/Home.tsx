...
import { Search, TrendingUp, Upload, History, Trash2, Edit2, Image as ImageIcon } from "lucide-react";
    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="flex items-center justify-between pt-4">
         ...
         <div className="flex items-center gap-3">
             ...
             <Link to="/editor/new" className="hidden sm:flex items-center gap-2 px-4 py-2 bg-zinc-800 border border-white/10 rounded-lg hover:bg-zinc-700 font-bold text-[11px] uppercase tracking-wider transition-colors text-zinc-300">
                <Upload className="w-4 h-4" /> Use Blank/Upload
             </Link>
         </div>
      </div>
