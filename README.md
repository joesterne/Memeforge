...
## ✨ Features
- **Advanced Meme Editor**: A full-featured canvas editor powered by `react-konva` for text, image, and shape manipulation, complete with drag-and-drop support and animated GIF export.
...
- **Performance Optimized**: Implements immutable asset caching, WebP support, and heavy dynamic code-splitting for rapid load times and 60FPS editor interactions.
...
- React 19 + TypeScript
- Tailwind CSS v4
- Canvas: React Konva (`react-konva`, `konva`)
